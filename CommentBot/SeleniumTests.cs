        ...
        public void CommentTest()
        {
            ...
            do
            {
                try
                {
                    ...
                    driver.FindElement(By.XPath("//textarea[@aria-label='Adicione um comentário...']")).SendKeys("Vou ganhar heim!!!");
                    Thread.Sleep(2000);
                ...
                catch (Exception ex)
                {
                    ...
                    try
                    {
                        driver.FindElement(By.XPath("//textarea[@aria-label='Adicione um comentário...']")).SendKeys("!!!");
                        driver.FindElement(By.XPath("//button[contains(text(),'Publicar')]")).Click();
                        Thread.Sleep(2000);

                        driver.FindElement(By.XPath("//textarea[@aria-label='Adicione um comentário...']")).SendKeys("qualquer coisa");
                        driver.FindElement(By.XPath("//button[contains(text(),'Publicar')]")).Click();
                    }
                    catch (Exception)
                    {
